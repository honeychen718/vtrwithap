...
bool DPBle::IsGroupMovable(Group& group, VPR_CLB*& sourceCLB, vector<int>& sourceGroup) {
...
Site* DPBle::MoveTowardOptrgn(Group& group, Box<double>& optrgn, VPR_CLB*& sourceCLB, vector<int>& sourceGroup) {

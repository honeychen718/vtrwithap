...
private:
    ...
    void DumpToDB();
    bool IsGroupMovable(Group& group, VPR_CLB*& sourceCLB, vector<int>& sourceGroup);
    bool MoveGroupToSite(Site* site, Group& group, VPR_CLB*& sourceCLB, vector<int>& sourceGroup);
